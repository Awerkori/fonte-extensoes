...
class WebViewInterceptor(val baseUrl: String, private val userAgent: String?) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (url.contains("app.leitordemangas.com") || url.contains("snipercache.com") || url.contains("/cdn/") || url.endsWith(".jpg") || url.endsWith(".png") || url.endsWith(".webp") || url.endsWith(".jpeg")) {
